# export CUDA_VISIBLE_DEVICES=$(free-gpus.sh 1); export HF_HUB_OFFLINE=1; export HF_DATASETS_OFFLINE=1; export TRANSFORMERS_OFFLINE=1; export HF_EVALUATE_OFFLINE=1; python DST_mw24_3_create_files.py
...
def parse_args():
    ...
    parser.add_argument("--output_folder_path", type=str, default="/mnt/matylda4/hegde/int_ent/TOD_llm/dialog_state_tracking/data/MULTIWOZ2.4/processed_data")
    parser.add_argument("--numpy_folder_path", type=str, default="/mnt/matylda4/hegde/int_ent/TOD_llm/dialog_state_tracking/data/MULTIWOZ2.4/numpy_files")
    ...
    parser.add_argument("--decoding", type=str, default="SKV", help="slot key and value given domain (SKV) | slot value given slot key (SV)")
...
def main():
    ...
    output_file_name = os.path.join(args.output_folder_path, f"{output_file_name}.txt")
    # breakpoint()
    ...
    # TSV file names
    test_TSV_file_path = os.path.join(args.output_folder_path, f"MW24_test_{args.dialog_history}_{args.punct}.tsv")
    train_TSV_file_path = os.path.join(args.output_folder_path, f"MW24_train_{args.dialog_history}_{args.punct}.tsv")
    ...
    test_numpy_file_path = '/mnt/matylda4/hegde/int_ent/TOD_llm/dialog_state_tracking/data/MULTIWOZ2.4/processed_data/MW24_test_U_O.npy'
    train_numpy_file_path = '/mnt/matylda4/hegde/int_ent/TOD_llm/dialog_state_tracking/data/MULTIWOZ2.4/processed_data/MW24_train_U_O.npy'
    ...
    # Add User: Agent: tag to the conversation by default and remove it later checking the argument.

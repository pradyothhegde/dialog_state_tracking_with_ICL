...
# from data_scripts.create_TSV_from_json_mixes import create_TSV_from_json_mixes
# from data_scripts.compute_save_sentence_embedding_mixes import compute_save_sentence_embedding_mixes
...
def parse_args():
    ...
    parser.add_argument("--output_folder_path", type=str, default="/mnt/matylda4/hegde/int_ent/TOD_llm/dialog_state_tracking/data/MW24/mixes")
    ...
    parser.add_argument("--mixes", type=str, default=False, help="True | False")
    parser.add_argument("--embedding_dialog_history", type=str, default="U", help="U | UA")
    # parser.add_argument("--
...
def main():
    ...
    output_folder_path = os.path.join(args.output_folder_path)
    output_file_name = os.path.join(output_folder_path, f"{output_file_name}_emb-{args.embedding_dialog_history}.txt")
    ...
    test_numpy_file_path = os.path.join(output_folder_path, f"MW24_test_{args.embedding_dialog_history}_{args.punct}P.npy")
    train_numpy_file_path = os.path.join(output_folder_path, f"MW24_train_{args.embedding_dialog_history}_{args.punct}P.npy")

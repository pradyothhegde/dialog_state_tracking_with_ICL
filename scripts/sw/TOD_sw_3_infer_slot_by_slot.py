...
def parse_args():
    ...
    parser.add_argument('--nec_files', type=str, default='/mnt/matylda4/hegde/int_ent/TOD_llm/experiments/sw/NecessaryFiles/')
    parser.add_argument('--output_folder_path', type=str, default='/mnt/matylda4/hegde/int_ent/TOD_llm/experiments/sw/')
    parser.add_argument('--out_folder_prefix', type=str, default='TOD_')
    parser.add_argument('--context_number', type=int, default=10)

    parser.add_argument('--input_file', type=str,       default='SW_LLM_input_UA.txt', help='Check necessary files folder for the appropriate file')
    parser.add_argument('--dialog_side', type=str,      default='U', help='U=user, UA=user-agent')
    parser.add_argument('--punct', type=str,            default='Y', help='Y=yes, N=no, R=repunctuated')
...
def main():
    ...
    # Load test file
    test_tsv_file_path = os.path.join(input_data_folder, 'SW_DST_test_U_turns.tsv')     # considered for filename, ground truth labels. 

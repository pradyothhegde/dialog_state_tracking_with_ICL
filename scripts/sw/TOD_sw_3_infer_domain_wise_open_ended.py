...
def parse_args():
    ...
    parser.add_argument('--input_file', type=str,       default='SW_LLM_input_UA_rem_NA.txt', help='Check necessary files folder for the appropriate file')
...
TOD_sw_O7BI_SD_I1_10_PY_TY filename indicates the following:
...
def main():
    ...
    # Load test file
    test_tsv_file_path = os.path.join(input_data_folder, 'SW_DST_test_U_turns.tsv')

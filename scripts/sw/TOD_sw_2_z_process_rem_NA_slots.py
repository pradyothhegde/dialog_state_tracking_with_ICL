# modify the LLM input file for open ended generation.
...
def arg_parse():
    ...
    parser.add_argument('--input_file', type=str, default='/mnt/matylda4/hegde/int_ent/TOD_llm/experiments/sw/NecessaryFiles/SW_LLM_input_UA_TN.txt', help='input file')

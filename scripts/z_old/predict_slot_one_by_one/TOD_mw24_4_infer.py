...
def main():
    ...
    # exit(0)
    #++++++++++++++++++++++++++++++++++++++++++++++++++
    similar_sentences_file_path = os.path.join(output_folder_path, 'LLM_input_sentences_rem_user_tag.txt')
    ...
    # for i, (test_line, sim_sentences_line) in enumerate(zip(test_data, sim_stored_lines)):
        ...
        if args.input_template == 1:
            ...
            if args.predict == 'domain':
                ...
                for loop_domain, loop_slots in zip(ast.literal_eval(gold_domain), ast.literal_eval(gold_slots)):

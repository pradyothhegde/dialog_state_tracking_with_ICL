...
input_data_path = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/data_refined.json'
testlistfile = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/testListFile.txt'
validlistfile = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/valListFile.txt'

# Paths to output JSON files for test, valid, and training sets
test_write_path = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/mw21_DST_test.json'
valid_write_path = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/mw21_DST_valid.json'
train_write_path = '/mnt/matylda4/hegde/int_ent/LLM_dialog_state/Data/MultiWOZ_2.1/mw21_DST_train.json'
